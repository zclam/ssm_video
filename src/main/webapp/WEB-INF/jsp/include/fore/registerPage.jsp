        ...
        <div class="registerDiv">
            ...
            <table class="registerTable" align="center">
                ...
                <tr>
                    ...
                    <td class="registerTableRightTD"><input id="name" name="user_name" placeholder="设置用户名"></td>
                </tr>
                <tr>
                    <td class="registerTip registerTableLeftTD">设置密码</td>
                    <td class="registerTableRightTD">登陆时验证</td>
                </tr>
                <tr>
                    <td class="registerTableLeftTD">密码</td>
                    <td class="registerTableRightTD"><input id="password" name="user_pwd" type="password"
                                                            placeholder="设置密码"></td>
                </tr>
                <tr>
